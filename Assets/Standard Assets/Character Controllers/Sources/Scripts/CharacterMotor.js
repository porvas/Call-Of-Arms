...
function Update () {
	...
	if (movement.run && !movement.sights){
		movement.maxGroundAcceleration = 45;
		//Speeds
		movement.maxForwardSpeed  = 22.0;
		movement.maxSidewaysSpeed = 12.0;
		movement.maxBackwardsSpeed = 15.0;
	}
	else if (movement.sights && !movement.run){
		movement.maxGroundAcceleration = 10;
		//Speeds
		movement.maxForwardSpeed  = 6.0;
		movement.maxSidewaysSpeed = 3.0;
		movement.maxBackwardsSpeed = 4.0;
	}
	else if (!movement.sights && !movement.run){
		movement.maxGroundAcceleration = 30;
		//Speeds
